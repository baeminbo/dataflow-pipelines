...
public class GloballyCombinePipeline {

  private static final Logger LOG = LoggerFactory.getLogger(GloballyCombinePipeline.class);
  ...
  public static void main(String[] args) {
    ...
    pipeline
        ...
        .apply(Combine
            .globally(new CombineFn<KV<String, Long>, List<Long>, Long>() {
              ...
              @Override
              public List<Long> addInput(List<Long> acc, KV<String, Long> input) {
                LOG.info("add input:{}", input);
                acc.add(input.getValue());
                return acc;
              }
            ...
            // Set withoutDefaults to avoid pipeline construction error
            .withoutDefaults())
