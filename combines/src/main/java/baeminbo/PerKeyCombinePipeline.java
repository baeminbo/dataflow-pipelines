...
public class PerKeyCombinePipeline {

  private static final Logger LOG = LoggerFactory.getLogger(PerKeyCombinePipeline.class);
  ...
  public static void main(String[] args) {
    ...
    pipeline
        ...
        .apply(Combine.perKey(new CombineFn<Long, List<Long>, Long>() {
