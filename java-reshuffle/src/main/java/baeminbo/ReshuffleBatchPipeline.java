...
public class ReshuffleBatchPipeline {
  private static final Logger LOG = LoggerFactory.getLogger(ReshuffleBatchPipeline.class);
  ...
  public static void main(String[] args) {
    ...
    })).apply(Reshuffle.viaRandomKey()).apply(ParDo.of(new DoFn<byte[], Long>() {
