...
public class Log4j2LoggingPipeline {
  public static class Log4jLoggingDoFn extends DoFn<Long, Void> {
    ...
    private static final org.apache.logging.log4j.Logger LOG4J_LOG = org.apache.logging.log4j.LogManager
        .getLogger(Log4jLoggingDoFn.class);
    ...
    public void processElement(ProcessContext context) throws InterruptedException {
      ...
      Thread.sleep(10000); // Sleep 10 seconds for logs in local file being updated to Cloud Logging.
    }
  }
  ...
  public static void main(String[] args) {
    ...
    pipeline
        .apply("Read", GenerateSequence.from(0).to(10))
